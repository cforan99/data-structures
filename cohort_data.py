...
def sort_by_cohort(filename):
    ...
    for line in cohort_data_file:
        ...
        elif line[4][-4:] == "2014" or line[4][-4:] == "2013":
            tas.append(name)
...
def find_cohort_by_student_name(first_name, last_name):
    ...
    student_cohort = [tpl[4] for tpl in all_students if tpl[0] == first_name and tpl[1] == last_name]

    if len(student_cohort) == 0:
        return "Student not found."
    else:
        return student_cohort[0]
